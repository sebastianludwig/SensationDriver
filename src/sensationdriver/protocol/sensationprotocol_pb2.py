...
_VIBRATION_REGION = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='LEFT_ARM', index=0, number=0,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RIGHT_ARM', index=1, number=1,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LEFT_UPPER_BODY', index=2, number=2,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RIGHT_UPPER_BODY', index=3, number=3,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LEFT_LEG', index=4, number=4,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RIGHT_LEG', index=5, number=5,
      options=None,
      type=None),
  ],
...
_TRACK.fields_by_name['target_region'].enum_type = _VIBRATION_REGION
_TRACK.fields_by_name['keyframes'].message_type = _TRACK_KEYFRAME
